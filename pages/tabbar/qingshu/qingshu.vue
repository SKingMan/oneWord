...
<uni-section title="情不知所起 一往而深" type="line">
			<uni-card class="sao_card">
				<image slot='cover' style="width: 100%;" :src="top_image.url"></image>
				<text class="uni-body">{{jok_content.data.content}}</text>
					...
					uni.request({
							...
							success: (res) => {
							  if (res.statusCode === 200) {
								...
								console.log(this.jok_content.data.content)
							  } else {
